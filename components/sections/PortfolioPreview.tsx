...
const GRADIENTS = [
  "linear-gradient(135deg, color-mix(in srgb,#00BCD4 18%,transparent), color-mix(in srgb,#FFBF00 10%,transparent))",
  "linear-gradient(135deg, color-mix(in srgb,#3F51B5 18%,transparent), color-mix(in srgb,#00BCD4 12%,transparent))",
  "linear-gradient(135deg, color-mix(in srgb,#4DD0E1 20%,transparent), color-mix(in srgb,#FFBF00 10%,transparent))",
  "linear-gradient(135deg, color-mix(in srgb,#FFBF00 16%,transparent), color-mix(in srgb,#00BCD4 12%,transparent))",
  "linear-gradient(135deg, color-mix(in srgb,#1E88E5 18%,transparent), color-mix(in srgb,#4DD0E1 12%,transparent))",
  "linear-gradient(135deg, color-mix(in srgb,#26C6DA 18%,transparent), color-mix(in srgb,#FFBF00 12%,transparent))",
];

export function PortfolioPreview({ lang, dictionary }: { lang: Locale; dictionary: Dictionary }) {
  const isAr = lang === "ar";
              ...
              <Reveal key={i} delay={i * 70}>
                <div className="apex-card-base apex-card-hover rounded-2xl overflow-hidden flex flex-col">
                  ...
                  >
                    ...
                    <span className="apex-tag absolute top-3 inset-e-3" style={{ insetInlineEnd: "12px" }}>
                      {p.tag}
                    </span>
                  </div>
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <h3
                      className={`font-bold mb-4 flex-1 ${isAr ? "font-ar" : "font-en"}`}
