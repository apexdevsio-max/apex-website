...
"ai-chatbot-cost": { emoji: "🤖", accentColor: "#FFBF00", categories: ["selected","practical"], readTime: 7 },
  ...
  "ecommerce-app-cost": { emoji: "🛍️", accentColor: "#00BCD4", categories: ["mobile","practical"], readTime: 9 },
  ...
  "travel-booking-app-cost": { emoji: "🏨", accentColor: "#7C4DFF", categories: ["mobile","practical"], readTime: 10 },
